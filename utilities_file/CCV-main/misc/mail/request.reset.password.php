                                ...
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#111111;">
                                        ...
                                        <div class="text-right"><a
                                                href="http://<?php echo $host ?>/ElevateHer/page/reset-password.php?accountId=<?php echo $accountId ?>&token=<?php echo $token ?>"
                                                id="resetPassword" target="_blank">CHANGE YOUR PASSWORD</a></div>
                                        <p
